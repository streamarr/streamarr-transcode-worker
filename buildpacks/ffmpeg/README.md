...
runs the downloaded binaries. Only after detecting a change and verifying the head SHA does it
mint a short-lived GitHub App token. Labels and comments use the workflow token, which cannot
